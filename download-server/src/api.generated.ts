...
export type TAllServerInfoGetError = '' | 'undefined';
export type TAllServerInfoPostError = '' | 'undefined';
export type TKeyActiveGetError = '' | 'undefined';
export type TKeyInfoGetError = '' | 'undefined';
export type TKeyPostError = '' | 'undefined';
export type TKeyAddYoutubeKeyPostError = '' | 'undefined';
export type TChannelExistPostError = '' | 'undefined';
...
export type TCommentAuthorIdsGetError = '' | 'undefined';
...
export type TServerInfoGetError = '' | 'undefined';
export type TStatisticInfoGetError = '' | 'undefined';
export type TStatisticByChannelGetError = '' | 'undefined';
export type TStatisticByChannelForOneGetError = '' | 'undefined';
export type TStatisticByVideoGetError = '' | 'undefined';
export type TStatisticGetError = '' | 'undefined';
export type TStatisticPostError = '' | 'undefined';
export type TStatisticIdGetError = '' | 'undefined';
export type TTaskChannelToStatisticGetError = '' | 'undefined';
export type TTaskStatisticToFirebaseGetError = '' | 'undefined';
export type TTaskRescanChannelsGetError = '' | 'undefined';
...
export const createApiRequest = (rs: IRequestService) => ({
    ...
    allServerInfoGet: (): CustomPromise<
        CustomAxiosResponse<IServerInfoDto, TAllServerInfoGetError>,
        IBEError<TAllServerInfoGetError>
    ...
    ): CustomPromise<CustomAxiosResponse<void, TAllServerInfoPostError>, IBEError<TAllServerInfoPostError>> =>
        rs.post(formatUrl(API_SERVER_URL + `/api/all-server-info`), body),

    // get active api-key.controller.ts
    keyActiveGet: (
        query: { old_key?: string; old_status?: string } | undefined,
    ...
    keyAddYoutubeKeyPost: (): CustomPromise<
        CustomAxiosResponse<void, TKeyAddYoutubeKeyPostError>,
        IBEError<TKeyAddYoutubeKeyPostError>
    > => rs.post(formatUrl(API_SERVER_URL + `/api/api-key/add-youtube-key`)),

    // post exist channel.controller.ts
    channelExistPost: (
        body: IExistBody,
    ): CustomPromise<CustomAxiosResponse<string[], TChannelExistPostError>, IBEError<TChannelExistPostError>> =>
    ...
    commentAuthorIdsGet: (): CustomPromise<
        CustomAxiosResponse<Date, TCommentAuthorIdsGetError>,
        IBEError<TCommentAuthorIdsGetError>
    > => rs.get(formatUrl(API_SERVER_URL + `/api/comment/author-ids`)),

    // get comment comment.controller.ts
    commentGet: (
        query: { comment_id?: string; author_id?: string } | undefined,
    ...
    statisticByChannelGet: (
        ...
        CustomAxiosResponse<IStatisticByChannel, TStatisticByChannelGetError>,
    ...
    statisticByChannelForOneGet: (
        query: { channel_id?: string } | undefined,
    ): CustomPromise<
        CustomAxiosResponse<IStatisticByChannelForOne, TStatisticByChannelForOneGetError>,
        IBEError<TStatisticByChannelForOneGetError>
    ...
    statisticByVideoGet: (
        ...
        CustomAxiosResponse<Array<IStatisticByVideo>, TStatisticByVideoGetError>,
    ...
    statisticGet: (): CustomPromise<
        CustomAxiosResponse<Array<IStatisticDto>, TStatisticGetError>,
        IBEError<TStatisticGetError>
    > => rs.get(formatUrl(API_SERVER_URL + `/api/statistic`)),

    // post statistic statistic.controller.ts
    statisticPost: (
        body: IStatisticPostBody,
    ): CustomPromise<CustomAxiosResponse<void, TStatisticPostError>, IBEError<TStatisticPostError>> =>
        rs.post(formatUrl(API_SERVER_URL + `/api/statistic`), body),

    // get {id} statistic.controller.ts
    statisticIdGet: (
        id: string,
    ): CustomPromise<CustomAxiosResponse<IStatisticDto, TStatisticIdGetError>, IBEError<TStatisticIdGetError>> =>
        rs.get(formatUrl(API_SERVER_URL + `/api/statistic/${id}`)),

    // get channel-to-statistic task.controller.ts
    taskChannelToStatisticGet: (): CustomPromise<
        CustomAxiosResponse<string, TTaskChannelToStatisticGetError>,
        IBEError<TTaskChannelToStatisticGetError>
    > => rs.get(formatUrl(API_SERVER_URL + `/api/task/channel-to-statistic`)),

    // get statistic-to-firebase task.controller.ts
    taskStatisticToFirebaseGet: (): CustomPromise<
        CustomAxiosResponse<string, TTaskStatisticToFirebaseGetError>,
        IBEError<TTaskStatisticToFirebaseGetError>
    > => rs.get(formatUrl(API_SERVER_URL + `/api/task/statistic-to-firebase`)),

    // get rescan-channels task.controller.ts
    taskRescanChannelsGet: (): CustomPromise<
        CustomAxiosResponse<string, TTaskRescanChannelsGetError>,
        IBEError<TTaskRescanChannelsGetError>
