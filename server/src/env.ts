...
export const ENV = {
    ...
    rabbit_mq_download_channel_name_for_scan: COMMON_ENV.rabbit_mq_download_channel_name_for_scan,
...
export const RABBIT_MQ_DOWNLOAD_ENV_FOR_SCAN = {
    channelName: ENV.rabbit_mq_download_channel_name_for_scan,
    rabbit_mq_url: ENV.rabbit_mq_url,
};
